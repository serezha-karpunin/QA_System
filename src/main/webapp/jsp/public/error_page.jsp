...
<fmt:bundle basename="language" prefix="error_page.">
...
<div id="page_wrapper">
    <div id="error_page_content_wrapper">
        <h1 class="error_page_title">${title}</h1>
        <p class="error_page_message">${message}</p><br>
        <div class="error_page_back_link_wrapper">
            <a class="error_page_back_link" href="/">${back}</a>
        </div>
    </div>
</div>