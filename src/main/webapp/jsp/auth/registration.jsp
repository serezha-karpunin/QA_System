...
<div id="page_wrapper">
    ...
    <div class="text_field_list">
        <form id="registration_form" action="/registration" method="post">
            ...
            <input id="login_field" name="login" type="text" placeholder="Create a login">
            <span id="error_missing_login">введите логин</span>
            <span id="error_not_valid_login">только буквы и цифры</span>
            <span id="error_used_login">этот логин занят</span>
            <br>
